...
void FPointDistanceQueryManagerAPI::initializeCH(string chFile) {
...
// the queries.
//______________________________________________________________________________________________________________________
double FPointDistanceQueryManagerAPI::distanceQuery(unsigned int source, unsigned int target) {
...
// serious problems.
//______________________________________________________________________________________________________________________
void FPointDistanceQueryManagerAPI::clearStructures() {
    delete qm;
    delete graph;
}
