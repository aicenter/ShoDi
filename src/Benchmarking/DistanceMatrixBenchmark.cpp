...
double DistanceMatrixBenchmark::benchmark(const std::vector < std::pair< unsigned int, unsigned int> > & trips, Distance_matrix_travel_time_provider<dist_t>& matrix, std::vector <dist_t> & distances) {
...
//______________________________________________________________________________________________________________________
double DistanceMatrixBenchmark::benchmarkUsingMapping(const std::vector < std::pair< long long unsigned int, long long unsigned int> > & trips, Distance_matrix_travel_time_provider<dist_t>& matrix, std::vector <dist_t> & distances, std::string mappingFilePath) {
