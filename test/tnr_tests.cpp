...
TEST(tnr_test, simple_test) {
    ...
    TNRGLoader tnrloader_gt_fast("../data/test/test_1_gt_fast.tnrg");
    ...
    // dm
    UpdateableGraph ch_graph_3(compute_ch_from_adj(std::filesystem::path("../data/test/adj.csv")));
    ...
    TNRGLoader tnrloader_gt("../data/test/test_1_gt.tnrg");
