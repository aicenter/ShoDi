...
TEST(ch_test, from_xengraph2) {
    ...
    compare_ch_files("from_xengraph2.ch", "functest/02_div100.ch");
}
...
TEST(ch_test, from_csv2) {
    ...
    compare_ch_files("from_csv2.ch", "functest/02_div100.ch");
}
...
TEST(ch_test, from_dimacs2) {
    ...
    compare_ch_files("from_dimacs2.ch", "functest/02_div100.ch");
}
