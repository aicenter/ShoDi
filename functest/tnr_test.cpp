...
TEST(tnr_test, from_xengraph3) {
    run_preprocessor("--method tnr --input-format xengraph --preprocessing-mode dm --tnodes-cnt 3 --input-file functest/01_xengraph.xeng --output-file from_xengraph3");
...
TEST(tnr_test, from_dimacs3) {
    run_preprocessor("--method tnr --input-format dimacs --preprocessing-mode dm --tnodes-cnt 1 --input-file functest/01_dimacs.gr --output-file from_dimacs3");
...
TEST(tnr_test, from_csv3) {
    run_preprocessor("--method tnr --input-format csv --preprocessing-mode dm --tnodes-cnt 2 --input-file functest/01_adj.csv --output-file from_csv3");
...
TEST(tnr_test, from_csv4) {
    run_preprocessor("--method tnr --input-format csv --preprocessing-mode dm --tnodes-cnt 2 --input-file functest/02_adj.csv --output-file from_csv4 --precision-loss 100");
