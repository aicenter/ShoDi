...
TEST(tnraf_test, from_xengraph2) {
    run_preprocessor("--method tnraf --input-format xengraph --preprocessing-mode dm --tnodes-cnt 2 --input-file functest/01_xengraph.xeng --output-file from_xengraph2");
...
TEST(tnraf_test, from_dimacs1) {
    run_preprocessor("--method tnraf --input-format dimacs --preprocessing-mode slow --tnodes-cnt 2 --input-file functest/01_dimacs.gr --output-file from_dimacs1");
...
TEST(tnraf_test, from_csv3) {
    run_preprocessor("--method tnraf --input-format csv --preprocessing-mode dm --tnodes-cnt 3 --input-file functest/02_adj.csv --output-file from_csv3 --precision-loss 100");
