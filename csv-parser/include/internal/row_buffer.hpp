...
namespace csv {
    namespace internals {
        ...
        using SplitArray = std::vector<uint32_t>;
        ...
        public:
             ...
             */
            RawRowBuffer(const std::string& _buffer, const std::vector<uint32_t>& _splits,
        ...
        struct ColumnPositions {
            ...
            constexpr ColumnPositions(const RawRowBuffer& _parent,
                size_t _start, uint32_t _size) : parent(&_parent), start(_start), n_cols(_size) {};
